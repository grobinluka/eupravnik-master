...
ActiveRecord::Schema.define(version: 20180415151612) do
  ...
  add_index "apartment_buildings", ["user_id"], name: "index_apartment_buildings_on_user_id"

  create_table "appartment_buildings", force: :cascade do |t|
    t.string   "name"
    t.string   "address"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
